...
3) HOW TO FILTER OR INTERPOLATE VCF FILES GIVEN A GENETIC MAP:
   ...
   • Filter VCF and genetic map with only X chromosome:                                                                                                                                      $ python $ADNA_PATH/filter_vcf.py --vcf tuscany_x.vcf --prefix interpolated_tuscanians --f_maps ./genetic_map/female_chr{}.txt --m_maps ./genetic_map/male_chr{}.txt --chrs [] --x_chr 23
   ...
   • Interpolate genetic map values given VCF with only autosomes:                                                                                                                           $ python $ADNA_PATH/filter_vcf.py --vcf tuscany_autosomes.vcf --prefix interpolated_tuscanians --f_maps ./genetic_map/female_chr{}.txt --m_maps ./genetic_map/male_chr{}.txt --interpolate

   • Interpolate genetic map values given VCF with only X chromosome:                                                                                                                        $ python $ADNA_PATH/filter_vcf.py --vcf tuscany_x.vcf --prefix interpolated_tuscanians --f_maps ./genetic_map/female_chr{}.txt --m_maps ./genetic_map/male_chr{}.txt --chrs [] --x_chr 23 --interpolate
